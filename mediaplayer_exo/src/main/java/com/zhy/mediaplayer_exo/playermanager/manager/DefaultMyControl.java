 ...
 */
public class DefaultMyControl implements LoadControl {
    ...
    /** Builder for {@link DefaultMyControl}. */
    public static final class Builder {
         ...
         */
        public DefaultMyControl.Builder setAllocator(DefaultAllocator allocator) {
         ...
         * @throws IllegalStateException If {@link #build()} has already been called.
         */
        public DefaultMyControl.Builder setBufferDurationsMs(
                int minBufferMs,
                int maxBufferMs,
         ...
         * @throws IllegalStateException If {@link #build()} has already been called.
         */
        public DefaultMyControl.Builder setTargetBufferBytes(int targetBufferBytes) {
            Assertions.checkState(!buildCalled);
         ...
         * @throws IllegalStateException If {@link #build()} has already been called.
         */
        public DefaultMyControl.Builder setPrioritizeTimeOverSizeThresholds(boolean prioritizeTimeOverSizeThresholds) {
            Assertions.checkState(!buildCalled);
         ...
         * @throws IllegalStateException If {@link #build()} has already been called.
         */
        public DefaultMyControl.Builder setBackBuffer(int backBufferDurationMs, boolean retainBackBufferFromKeyframe) {
            Assertions.checkState(!buildCalled);
        ...
        @Deprecated
        public DefaultMyControl createDefaultMyControl() {
            return build();
        }

        /** Creates a {@link DefaultMyControl}. */
        public DefaultMyControl build() {
            Assertions.checkState(!buildCalled);
            buildCalled = true;
            if (allocator == null) {
                allocator = new DefaultAllocator(/* trimOnReset= */ true, C.DEFAULT_BUFFER_SEGMENT_SIZE);
            }
            return new DefaultMyControl(
                    allocator,
                    minBufferMs,
                    maxBufferMs,
                    bufferForPlaybackMs,
    ...
    public DefaultMyControl() {
        this(new DefaultAllocator(true, C.DEFAULT_BUFFER_SEGMENT_SIZE));
    }

    /** @deprecated Use {@link DefaultMyControl.Builder} instead. */
    @Deprecated
    public DefaultMyControl(DefaultAllocator allocator) {
        this(
                allocator,
    ...
    public boolean shouldContinueLoading(
        ...
        minBufferUs = max(minBufferUs, Integer.MAX_VALUE);
        if (bufferedDurationUs < minBufferUs) {
            isBuffering = prioritizeTimeOverSizeThresholds || !targetBufferSizeReached;
            if (!isBuffering && bufferedDurationUs < Integer.MAX_VALUE) {
                Log.w(
                        "DefaultMyControl",
